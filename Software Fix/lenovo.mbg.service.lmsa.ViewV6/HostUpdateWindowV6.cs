...
public partial class HostUpdateWindowV6 : Window, IComponentConnector
{
	...
	public static readonly DependencyProperty StrPercentProperty = DependencyProperty.Register("StrPercent", typeof(string), typeof(HostUpdateWindowV6), new PropertyMetadata(string.Empty));

	public static readonly DependencyProperty PercentNumProperty = DependencyProperty.Register("PercentNum", typeof(double), typeof(HostUpdateWindowV6), new PropertyMetadata(0.0));

	public static readonly DependencyProperty StrDownloadSpeedProperty = DependencyProperty.Register("StrDownloadSpeed", typeof(string), typeof(HostUpdateWindowV6), new PropertyMetadata(string.Empty));
	...
	private void btnInstallNow_Click(object sender, RoutedEventArgs e)
	{
		...
		btnCalcelInstall.IsEnabled = false;
		Task.Run(delegate
		{
	...
	{
		if (base.DataContext is VersionModel { ForceType: not false })
		{
			...
			else if (Application.Current.MainWindow is MainWindow && MainWindowViewModel.SingleInstance.CheckCanCloseWindow())
			{
