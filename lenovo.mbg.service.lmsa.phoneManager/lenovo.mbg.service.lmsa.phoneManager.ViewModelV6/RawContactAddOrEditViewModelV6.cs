...
public class RawContactAddOrEditViewModelV6 : ViewModelBase
{
	private static ImageSource _defaultImage;

	private string _name = string.Empty;

	private ObservableCollection<ContactItemPhoneViewModelV6> _numberList;

	private ObservableCollection<ContactItemPhoneViewModelV6> _emailList;

	private ObservableCollection<ContactItemPhoneViewModelV6> _addressList;
	...
	public ObservableCollection<ContactItemPhoneViewModelV6> PhoneNumberList
	{
		get
		{
			return _numberList;
	...
	public ObservableCollection<ContactItemPhoneViewModelV6> EmailList
	{
		get
		{
			return _emailList;
	...
	public ObservableCollection<ContactItemPhoneViewModelV6> AddressList
	{
		get
		{
			return _addressList;
	...
	private void AddNewElement(ObservableCollection<ContactItemPhoneViewModelV6> _list, ContactInfoType _type)
	{
		ContactItemPhoneViewModelV6 item = new ContactItemPhoneViewModelV6
		{
		...
		ContactItemPhoneViewModelV6 contactItemPhoneViewModelV = _list.Last();
		contactItemPhoneViewModelV.IsLast = false;
		_list.RemoveAt(_list.Count - 1);
		_list.Add(contactItemPhoneViewModelV);
		_list.Add(item);
	}
	...
	{
		Tuple<RawContactDetail, ContactDetailViewModelV6> obj = data as Tuple<RawContactDetail, ContactDetailViewModelV6>;
		RawContactDetail item = obj.Item1;
		ContactDetailViewModelV6 item2 = obj.Item2;
		RawContactDetailData = item;
		Id = item.RawContactId;
		Name = item.Name;
		AvatarId = item.AvatarIdInDataTable;
		if (item2.AvatarImage != null && !string.IsNullOrEmpty(AvatarId) && AvatarId.Equals(item.AvatarIdInDataTable) && !item2.AvatarImage.ToString().Equals(ContactDetailViewModelV6.AvatarDefaultImagePath))
		{
		...
		foreach (ContactGroupItemViewModelV6 item3 in ContactViewModelV6.ContactDataCache.Single.GetAllContactsGroup())
		{
		...
		PhoneNumberList = new ObservableCollection<ContactItemPhoneViewModelV6>(list);
		...
		EmailList = new ObservableCollection<ContactItemPhoneViewModelV6>(list2);
		...
		AddressList = new ObservableCollection<ContactItemPhoneViewModelV6>(list3);
	}
}
