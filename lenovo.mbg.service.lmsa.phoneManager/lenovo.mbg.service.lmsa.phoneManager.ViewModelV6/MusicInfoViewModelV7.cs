...
public class MusicInfoViewModelV7 : ViewModelBase, ISupportInitialize, IWeakEventListener
{
	...
	public MusicInfoViewModelV7(MusicInfo Music)
	{
		ID = Music.ID;
		SongName = Music.DisplayName;
		IntDuration = Music.Duration;
		Duration = new TimeSpan(0, 0, Music.Duration / 1000).ToString("mm\\:ss");
