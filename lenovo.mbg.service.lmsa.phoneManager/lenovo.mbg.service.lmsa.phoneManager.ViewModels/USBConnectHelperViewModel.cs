...
public class USBConnectHelperViewModel : ViewModelBase
{
	private int _Index;
	...
	public ReplayCommand WiFiConnCommand { get; set; }
	...
	public USBConnectHelperViewModel()
	{
		isPhone = true;
		IsNormalPhone = true;
		SetPhoneView();
		WiFiConnCommand = new ReplayCommand(delegate
		{
