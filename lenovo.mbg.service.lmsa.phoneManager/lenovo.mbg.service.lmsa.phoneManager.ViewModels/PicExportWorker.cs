...
public class PicExportWorker : IDisposable
{
	private class ExportTask : IDisposable
	{
		private PicInfoViewModel m_pic;

		private PicExportWorker m_outer;

		public ExportTask(PicExportWorker outer, PicInfoViewModel pic)
		{
			m_outer = outer;
			m_pic = pic;
		}
	...
	public PicExportWorker(Action<string, TransferResult, string> resultHandler)
	{
		m_resultHandler = resultHandler;
	}

	public string BeginExport(PicInfoViewModel pic)
	{
